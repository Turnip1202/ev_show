...
```powershell
# 克隆仓库
git clone https://github.com/XtangUser/ev_show.git
cd ev_show
...
**[⬇️ 下载 ev_show_v1.0.0_windows_x64.zip](https://github.com/XtangUser/ev_show/raw/main/dist/ev_show_v1.0.0_windows_x64.zip)**

解压后双击 `ev_show.exe` 运行即可，无需安装任何运行时。
...
**[⬇️ Download ev_show_v1.0.0_windows_x64.zip](https://github.com/XtangUser/ev_show/raw/main/dist/ev_show_v1.0.0_windows_x64.zip)**

Unzip and run `ev_show.exe` directly — no development environment needed.
